...
export default function ImagePreviewModal({
  ...
  return (
    ...
    >
      <div
        className="relative w-full max-w-3xl rounded-[24px] overflow-hidden flex flex-col"
        style={{
      ...
      >
        ...
        <div className="flex items-center justify-between px-5 py-3 border-b border-[var(--color-border)]">
          <div className="flex items-center gap-3 min-w-0">
            ...
            <span className="text-xs text-[var(--color-text-muted)] truncate">
              Human review only — agent does not read image content yet
            </span>
          </div>
          <button
            onClick={onClose}
        ...
        {/* Image */}
        <div className="relative flex items-center justify-center bg-[var(--color-bg-primary)] min-h-[320px] max-h-[60vh] overflow-hidden">
          <img
            key={image.id}
